...
function resetEvents($el) {
    ...
    $(document).off('mousemove.linkselection');
    mouseMoved = false;

}


$('a').on('mousedown.linkselection', function (downEvent) {
    ...
    let thisYCoord = downEvent.pageY - this.offsetTop;
    ...
    // if(currentLine == 1){
    //     start_coods.y = this.offsetTop;
    // }else if(currentLine == linesCount){
    //     start_coods.y = (this.offsetTop + thisHeight) - thisLineHeight + 1;
    // }else {
    //     start_coods.y = this.offsetTop + (thisLineHeight * (currentLine - 1)) + 1;
    // }
    ...
    $(document).on('mousemove.linkselection', function (moveEvent) {
        ...
        if(Math.sign(moveOffsetX) == 1 || Math.sign(moveOffsetX) == 0){
            if(currentLine == 1){
                start_coods.y = this_a.offsetTop;
            }else if(currentLine == linesCount){
                start_coods.y = (this_a.offsetTop + thisHeight) - thisLineHeight + 1;
            }else {
                start_coods.y = this_a.offsetTop + (thisLineHeight * (currentLine - 1)) + 1;
            }
        }else if(Math.sign(moveOffsetX) == -1){
            if(currentLine == 1){
                start_coods.y = this_a.offsetTop + thisLineHeight - 1;
            }else if(currentLine == linesCount){
                start_coods.y = (this_a.offsetTop + thisHeight) - 1;
            }else {
                start_coods.y = this_a.offsetTop + (thisLineHeight * currentLine) - 1;
            }                    
        }
